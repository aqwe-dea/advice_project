...
function AgentGem() {
    ...
    const sendQuestion = async () => {
        ...
        try {
            ...
            // в поле где вопрос прописываем то что отправляем агенту
            // заменяем question на то что хотим отправить агенту
            // ниже создаем поле place hold input для от отправки запроса того что хотим
        ...
        > 
            ...
            {isLoading && (
                ...
                <div className="loading-spinner" style={{marginRight: '0.5rem'}}>⏳</div>
                    АКВИ размышляет или выполняет задание...
                </div>
            )}
            </div>   
            {/* Поле ввода */}
            ...
            <div style={{display: 'flex', gap: '0.5rem'}}>
                <input
                    ...
                    placeholder="Спросить АКВИ или попросить сделать что нибудь..."
                    style={{
                        flex: 1,
                        padding: '0.75rem',
                        borderRadius: '8px',
