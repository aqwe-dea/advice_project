        ...
        try:
            ...
            prompt = f"""
                ...
                Учебник должен содержать:
                    ...
                    2. Введение (1-4 стр.)
                    3. Основные теоретические разделы (4-40 стр.)
                    4. Практические задания и кейсы (40-45 стр.)
                    5. Контрольные вопросы (45-47 стр.)
                    6. Рекомендации по дальнейшему изучению (47-50 стр.)
                ...
                Требования к формату:
                    ...
                    - Все разделы должны быть наполнены текстом (полезным контентом)
                    - Используйте таблицы и графики там где это необходимо.
                    - Объем: 10000-100000 символов (не более 7000 слов)
                ...
                ## 2. Главы и подглавы (как в структуре курса разделы, но с подробным наполнением)

                ## 3. Полный текст всего курса-учебника (с абзацами и отступами)
