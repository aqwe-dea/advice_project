...
def save_to_memory(entry: str, emotion: str = None, memory_file: str = "accumulateexperience.md") -> str:
    ...
    try:
        ...
        with open(path, "a", encoding="utf-8") as f:
            f.write(formatted)
        return json.dumps({"status": "success", "emotion": emotion, "file": str(path)}, ensure_ascii=False)
